...
import com.sigmasoftware.akucherenko.thecocktaildb.databinding.FragmentCocktailBinding
 ...
 */
class CocktailFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private suspend fun getData(): Drinks {
        ...
        return service.drinkList(1, "Cocktail")
    }
